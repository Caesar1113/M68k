...
; printf("\r\nDump Memory Block: <ESC> to Abort, <SPACE> to Continue") ;
       pea       @m68kdebugDumpMemory_5.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nEnter Start Address: ") ;
       pea       @m68kdebugDumpMemory_6.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nFill Memory Block") ;
       pea       @m68kdebugFillMemory_11.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nEnter Start Address: ") ;
       pea       @m68kdebugFillMemory_12.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nUse HyperTerminal to Send Text File (.hex)\r\n") ;
       pea       @m68kdebugLoad_SRecordFile_16.L
       jsr       (A4)
       addq.w    #4,A7
; while(1)    {
Load_SRecordFile_1:
...
; printf("\r\nLoad Failed at Address = [$%08X]\r\n", FailedAddress) ;
       move.l    -26(A6),-(A7)
       pea       @m68kdebugLoad_SRecordFile_17.L
       jsr       (A4)
       addq.w    #8,A7
...
; printf("\r\nSuccess: Downloaded %d bytes\r\n", ByteTotal) ;
       move.l    A5,-(A7)
       pea       @m68kdebugLoad_SRecordFile_18.L
       jsr       (A4)
       addq.w    #8,A7
Load_SRecordFile_26:
...
; printf("\r\nExamine and Change Memory") ;
       pea       @m68kdebugMemoryChange_19.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n<ESC> to Stop, <SPACE> to Advance, '-' to Go Back, <DATA> to change") ;
       pea       @m68kdebugMemoryChange_20.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nEnter Address: ") ;
       pea       @m68kdebugMemoryChange_21.L
       jsr       (A2)
       addq.w    #4,A7
; RamPtr = Get8HexDigits(0) ;
       clr.l     -(A7)
...
; printf("\r\n[%08x] : %02x  ", RamPtr, *RamPtr) ;
       ...
       move.l    D1,-(A7)
       move.l    D3,-(A7)
       pea       @m68kdebugMemoryChange_22.L
       jsr       (A2)
       add.w     #12,A7
; c = tolower(_getch()) ;
       move.l    D0,-(A7)
...
; printf("\r\nWarning Change Failed: Wrote [%02x], Read [%02x]", Data, *RamPtr) ;
       ...
       move.l    D1,-(A7)
       move.l    D4,-(A7)
       pea       @m68kdebugMemoryChange_23.L
       jsr       (A2)
       add.w     #12,A7
MemoryChange_11:
...
; printf("\r\nLoading Program From SPI Flash....") ;
       pea       @m68kdebugLoadFromFlashChip_24.L
       jsr       _printf
       addq.w    #4,A7
       rts
; //
...
; sprintf(WatchPointString[x], "$%08X  ", WatchPointAddress[x]) ;
       ...
       move.l    0(A0,D1.L),-(A7)
       pea       @m68kdebugDumpRegisters_25.L
       move.l    A5,D1
       ext.l     D2
       move.l    D0,-(A7)
       move.l    D2,D0
...
; sprintf(TempString, "%02X", BytePointer[j+k]) ;
       ...
       and.l     #255,D1
       move.l    D1,-(A7)
       pea       @m68kdebugDumpRegisters_26.L
       pea       _TempString.L
       jsr       _sprintf
       add.w     #12,A7
...
; strcat(WatchPointString[x]," ") ;
       pea       @m68kdebugDumpRegisters_27.L
       move.l    A5,D1
       ext.l     D2
       move.l    D0,-(A7)
       move.l    D2,D0
...
; }
; strcat(WatchPointString[x], "  ") ;
       pea       @m68kdebugDumpRegisters_28.L
       move.l    A5,D1
       ext.l     D2
       move.l    D0,-(A7)
       move.l    D2,D0
...
DumpRegisters_17:
; sprintf(TempString, ".") ;
       pea       @m68kdebugDumpRegisters_29.L
       pea       _TempString.L
       jsr       _sprintf
       addq.w    #8,A7
...
; sprintf(TempString, "%c", BytePointer[j]) ;
       ...
       and.l     #255,D1
       move.l    D1,-(A7)
       pea       @m68kdebugDumpRegisters_30.L
       pea       _TempString.L
       jsr       _sprintf
       add.w     #12,A7
DumpRegisters_16:
...
; strcpy(WatchPointString[x], "") ;
       pea       @m68kdebugDumpRegisters_31.L
       move.l    A5,D1
       ext.l     D2
       move.l    D0,-(A7)
       move.l    D2,D0
...
; printf("\r\n\r\n D0 = $%08X  A0 = $%08X",d0,a0) ;
       move.l    _a0.L,-(A7)
       move.l    _d0.L,-(A7)
       pea       @m68kdebugDumpRegisters_32.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n D1 = $%08X  A1 = $%08X",d1,a1) ;
       move.l    _a1.L,-(A7)
       move.l    _d1.L,-(A7)
       pea       @m68kdebugDumpRegisters_33.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n D2 = $%08X  A2 = $%08X",d2,a2) ;
       move.l    _a2.L,-(A7)
       move.l    _d2.L,-(A7)
       pea       @m68kdebugDumpRegisters_34.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n D3 = $%08X  A3 = $%08X",d3,a3) ;
       move.l    _a3.L,-(A7)
       move.l    _d3.L,-(A7)
       pea       @m68kdebugDumpRegisters_35.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n D4 = $%08X  A4 = $%08X",d4,a4) ;
       move.l    _a4.L,-(A7)
       move.l    _d4.L,-(A7)
       pea       @m68kdebugDumpRegisters_36.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n D5 = $%08X  A5 = $%08X",d5,a5) ;
       move.l    _a5.L,-(A7)
       move.l    _d5.L,-(A7)
       pea       @m68kdebugDumpRegisters_37.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n D6 = $%08X  A6 = $%08X",d6,a6) ;
       move.l    _a6.L,-(A7)
       move.l    _d6.L,-(A7)
       pea       @m68kdebugDumpRegisters_38.L
       jsr       (A3)
       add.w     #12,A7
...
DumpRegisters_19:
       move.l    D1,-(A7)
       move.l    _d7.L,-(A7)
       pea       @m68kdebugDumpRegisters_39.L
       jsr       (A3)
       add.w     #12,A7
; printf("\r\n\r\nUSP = $%08X  (A7) User SP", USP ) ;
       move.l    _USP.L,-(A7)
       pea       @m68kdebugDumpRegisters_40.L
       jsr       (A3)
       addq.w    #8,A7
; printf("\r\nSSP = $%08X  (A7) Supervisor SP", SSP) ;
       move.l    _SSP.L,-(A7)
       pea       @m68kdebugDumpRegisters_41.L
       jsr       (A3)
       addq.w    #8,A7
; printf("\r\n SR = $%04X   ",SR) ;
       move.w    (A4),D1
       and.l     #65535,D1
       move.l    D1,-(A7)
       pea       @m68kdebugDumpRegisters_42.L
       jsr       (A3)
       addq.w    #8,A7
; // display the status word in characters etc.
; printf("   [") ;
       pea       @m68kdebugDumpRegisters_43.L
       jsr       (A3)
       addq.w    #4,A7
...
; printf("\r\n PC = $%08X  ", PC) ;
       move.l    _PC.L,-(A7)
       pea       @m68kdebugDumpRegisters_44.L
       jsr       (A3)
       addq.w    #8,A7
...
; printf("[@ BREAKPOINT]") ;
       pea       @m68kdebugDumpRegisters_45.L
       jsr       (A3)
       addq.w    #4,A7
DumpRegisters_40:
; printf("\r\n") ;
       pea       @m68kdebugDumpRegisters_46.L
       jsr       (A3)
       addq.w    #4,A7
; for(i=0; i < 8; i++)    {
       clr.w     D4
...
; printf("\r\nWP%d = %s", i, WatchPointString[i]) ;
       ...
       ext.l     D4
       move.l    D4,-(A7)
       pea       @m68kdebugDumpRegisters_47.L
       jsr       (A3)
       add.w     #12,A7
DumpRegisters_45:
       addq.w    #1,D4
...
_DumpRegistersandPause:
       ...
       lea       _printf.L,A2
; printf("\r\n\r\n\r\n\r\n\r\n\r\nSingle Step  :[ON]") ;
       pea       @m68kdebugDumpRegistersandPause_48.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nBreak Points :[Disabled]") ;
       pea       @m68kdebugDumpRegistersandPause_49.L
       jsr       (A2)
       addq.w    #4,A7
; DumpRegisters() ;
       jsr       _DumpRegisters
; printf("\r\nPress <SPACE> to Execute Next Instruction");
       pea       @m68kdebugDumpRegistersandPause_50.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nPress <ESC> to Resume Program") ;
       pea       @m68kdebugDumpRegistersandPause_51.L
       jsr       (A2)
       addq.w    #4,A7
; menu() ;
       jsr       _menu
...
; printf("\r\nIllegal Data Register : Use D0-D7.....\r\n") ;
       pea       @m68kdebugChangeRegisters_52.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
...
; printf("\r\nD%c = ", c) ;
       ...
       ext.l     D2
       move.l    D2,-(A7)
       pea       @m68kdebugChangeRegisters_53.L
       jsr       (A2)
       addq.w    #8,A7
...
; printf("\r\nIllegal Address Register : Use A0-A7.....\r\n") ;
       pea       @m68kdebugChangeRegisters_54.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
       bra       ChangeRegisters_6
...
; printf("\r\nA%c = ", c) ;
       ...
       ext.l     D2
       move.l    D2,-(A7)
       pea       @m68kdebugChangeRegisters_55.L
       jsr       (A2)
       addq.w    #8,A7
; reg_val = Get8HexDigits(0) ;    // read 32 bit value from user keyboard
       clr.l     -(A7)
...
; printf("\r\nUser SP = ") ;
       pea       @m68kdebugChangeRegisters_56.L
       jsr       (A2)
       addq.w    #4,A7
...
; else {
; printf("\r\nIllegal Register....") ;
       pea       @m68kdebugChangeRegisters_57.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
       bra       ChangeRegisters_6
...
; printf("\r\nSystem SP = ") ;
       pea       @m68kdebugChangeRegisters_58.L
       jsr       (A2)
       addq.w    #4,A7
...
; else {
; printf("\r\nIllegal Register....") ;
       pea       @m68kdebugChangeRegisters_59.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
       bra       ChangeRegisters_6
...
; else if((reg[0] == (char)('p')) && (c == (char)('c')))  {    // change program counter
       ...
       bne.s     ChangeRegisters_48
; printf("\r\nPC = ") ;
       pea       @m68kdebugChangeRegisters_60.L
       jsr       (A2)
       addq.w    #4,A7
...
; else if((reg[0] == (char)('s')) && (c == (char)('r')))  {    // change status register
       ...
       bne.s     ChangeRegisters_50
; printf("\r\nSR = ") ;
       pea       @m68kdebugChangeRegisters_61.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nIllegal Register: Use A0-A7, D0-D7, SSP, USP, PC or SR\r\n") ;
       pea       @m68kdebugChangeRegisters_62.L
       jsr       (A2)
       addq.w    #4,A7
ChangeRegisters_51:
; DumpRegisters() ;
...
; printf("\r\n\r\nNum     Address      Instruction") ;
       pea       @m68kdebugBreakPointDisplay_63.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n---     ---------    -----------") ;
       pea       @m68kdebugBreakPointDisplay_64.L
       jsr       (A2)
       addq.w    #4,A7
...
; else
; printf("\r\nNo BreakPoints Set") ;
       pea       @m68kdebugBreakPointDisplay_65.L
       jsr       (A2)
       addq.w    #4,A7
BreakPointDisplay_7:
; for(i = 0; i < 8; i++)  {
...
; printf("\r\n%3d     $%08x",i, BreakPointAddress[i]) ;
       ...
       move.l    0(A3,D1.L),-(A7)
       move.l    D2,-(A7)
       pea       @m68kdebugBreakPointDisplay_66.L
       jsr       (A2)
       add.w     #12,A7
...
; }
; printf("\r\n") ;
       pea       @m68kdebugBreakPointDisplay_67.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nNum     Address") ;
       pea       @m68kdebugWatchPointDisplay_68.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n---     ---------") ;
       pea       @m68kdebugWatchPointDisplay_69.L
       jsr       (A2)
       addq.w    #4,A7
...
; else
; printf("\r\nNo WatchPoints Set") ;
       pea       @m68kdebugWatchPointDisplay_70.L
       jsr       (A2)
       addq.w    #4,A7
WatchPointDisplay_7:
; for(i = 0; i < 8; i++)  {
...
; printf("\r\n%3d     $%08x",i, WatchPointAddress[i]) ;
       ...
       move.l    0(A0,D1.L),-(A7)
       move.l    D2,-(A7)
       pea       @m68kdebugWatchPointDisplay_71.L
       jsr       (A2)
       add.w     #12,A7
...
; }
; printf("\r\n") ;
       pea       @m68kdebugWatchPointDisplay_72.L
       jsr       (A2)
       addq.w    #4,A7
       movem.l   (A7)+,D2/D3/A2
       rts
...
; printf("\r\nEnter Break Point Number: ") ;
       pea       @m68kdebugBreakPointClear_73.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nIllegal Range : Use 0 - 7") ;
       pea       @m68kdebugBreakPointClear_74.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
...
; BreakPointInstruction[i] = 0 ;
       ...
       clr.w     0(A0,D0.L)
; printf("\r\nBreak Point Cleared.....\r\n") ;
       pea       @m68kdebugBreakPointClear_75.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nBreak Point wasn't Set.....") ;
       pea       @m68kdebugBreakPointClear_76.L
       jsr       (A2)
       addq.w    #4,A7
BreakPointClear_6:
; BreakPointDisplay() ;
...
; printf("\r\nEnter Watch Point Number: ") ;
       pea       @m68kdebugWatchPointClear_77.L
       jsr       (A2)
       addq.w    #4,A7
...
WatchPointClear_3:
; printf("\r\nIllegal Range : Use 0 - 7") ;
       pea       @m68kdebugWatchPointClear_78.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
...
; WatchPointSetOrCleared[i] = 0 ;
       ...
       clr.l     0(A0,D0.L)
; printf("\r\nWatch Point Cleared.....\r\n") ;
       pea       @m68kdebugWatchPointClear_79.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nWatch Point Was not Set.....") ;
       pea       @m68kdebugWatchPointClear_80.L
       jsr       (A2)
       addq.w    #4,A7
WatchPointClear_6:
; WatchPointDisplay() ;
...
; printf("\r\nNo FREE Break Points.....") ;
       pea       @m68kdebugSetBreakPoint_81.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
...
; }
; printf("\r\nBreak Point Address: ") ;
       pea       @m68kdebugSetBreakPoint_82.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nError : Break Points CANNOT be set at ODD addresses") ;
       pea       @m68kdebugSetBreakPoint_83.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
       bra       SetBreakPoint_15
...
; printf("\r\nError : Break Points CANNOT be set for ROM in Range : [$0-$00007FFF]") ;
       pea       @m68kdebugSetBreakPoint_84.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
       bra       SetBreakPoint_15
...
; printf("\r\nError: Break Point Already Exists at Address : %08x\r\n", BPAddress) ;
       move.l    D3,-(A7)
       pea       @m68kdebugSetBreakPoint_85.L
       jsr       (A2)
       addq.w    #8,A7
; return ;
       bra       SetBreakPoint_15
...
; printf("\r\nBreak Point Set at Address: [$%08x]", ProgramBreakPointAddress) ;
       move.l    D4,-(A7)
       pea       @m68kdebugSetBreakPoint_86.L
       jsr       (A2)
       addq.w    #8,A7
...
; BreakPointAddress[i] = BPAddress ;                              // record the address of this break point in the debugger
       ...
       move.l    D3,0(A0,D0.L)
; printf("\r\n") ;
       pea       @m68kdebugSetBreakPoint_87.L
       jsr       (A2)
       addq.w    #4,A7
; BreakPointDisplay() ;       // display the break points
       jsr       _BreakPointDisplay
...
; printf("\r\nNo FREE Watch Points.....") ;
       pea       @m68kdebugSetWatchPoint_88.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
...
; }
; printf("\r\nWatch Point Address: ") ;
       pea       @m68kdebugSetWatchPoint_89.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nError: Watch Point Already Set at Address : %08x\r\n", WPAddress) ;
       move.l    D3,-(A7)
       pea       @m68kdebugSetWatchPoint_90.L
       jsr       (A2)
       addq.w    #8,A7
; return ;
       bra       SetWatchPoint_11
...
; printf("\r\nWatch Point Set at Address: [$%08x]", WPAddress) ;
       move.l    D3,-(A7)
       pea       @m68kdebugSetWatchPoint_91.L
       jsr       (A2)
       addq.w    #8,A7
; WatchPointAddress[i] = WPAddress ;                              // record the address of this watch point in the debugger
       ...
       move.l    D3,0(A0,D0.L)
; printf("\r\n") ;
       pea       @m68kdebugSetWatchPoint_92.L
       jsr       (A2)
       addq.w    #4,A7
; WatchPointDisplay() ;       // display the break points
       jsr       _WatchPointDisplay
...
; PC = PC - 2 ;  // ready for user to resume after reaching breakpoint
       subq.l    #2,(A4)
; printf("\r\n\r\n\r\n\r\n@BREAKPOINT") ;
       pea       @m68kdebugHandleBreakPoint_93.L
       jsr       (A3)
       addq.w    #4,A7
; printf("\r\nSingle Step : [ON]") ;
       pea       @m68kdebugHandleBreakPoint_94.L
       jsr       (A3)
       addq.w    #4,A7
; printf("\r\nBreakPoints : [Enabled]") ;
       pea       @m68kdebugHandleBreakPoint_95.L
       jsr       (A3)
       addq.w    #4,A7
...
; DumpRegisters() ;
       jsr       _DumpRegisters
; printf("\r\nPress <SPACE> to Execute Next Instruction");
       pea       @m68kdebugHandleBreakPoint_96.L
       jsr       (A3)
       addq.w    #4,A7
; printf("\r\nPress <ESC> to Resume User Program\r\n") ;
       pea       @m68kdebugHandleBreakPoint_97.L
       jsr       (A3)
       addq.w    #4,A7
; menu() ;
       jsr       _menu
...
_UnknownCommand:
; printf("\r\nUnknown Command.....\r\n") ;
       pea       @m68kdebugUnknownCommand_98.L
       jsr       _printf
       addq.w    #4,A7
; Help() ;
       jsr       _Help
...
; printf("\r\nProgram Ended (TRAP #15)....") ;
       pea       @m68kdebugCallDebugMonitor_99.L
       jsr       _printf
       addq.w    #4,A7
; menu();
       jsr       _menu
...
; printf("\r\n  .(reg)       - Change Registers: e.g A0-A7,D0-D7,PC,SSP,USP,SR");
       pea       @m68kdebugHelp_104.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  BD/BS/BC/BK  - Break Point: Display/Set/Clear/Kill") ;
       pea       @m68kdebugHelp_105.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  C            - Copy Program from Flash to Main Memory") ;
       pea       @m68kdebugHelp_106.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  D            - Dump Memory Contents to Screen") ;
       pea       @m68kdebugHelp_107.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  E            - Enter String into Memory") ;
       pea       @m68kdebugHelp_108.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  F            - Fill Memory with Data") ;
       pea       @m68kdebugHelp_109.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  G            - Go Program Starting at Address: $%08X", PC) ;
       move.l    _PC.L,-(A7)
       pea       @m68kdebugHelp_110.L
       jsr       (A2)
       addq.w    #8,A7
; printf("\r\n  L            - Load Program (.HEX file) from Laptop") ;
       pea       @m68kdebugHelp_111.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  M            - Memory Examine and Change");
       pea       @m68kdebugHelp_112.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  P            - Program Flash Memory with User Program") ;
       pea       @m68kdebugHelp_113.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  R            - Display 68000 Registers") ;
       pea       @m68kdebugHelp_114.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  S            - Toggle ON/OFF Single Step Mode") ;
       pea       @m68kdebugHelp_115.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  TM           - Test Memory") ;
       pea       @m68kdebugHelp_116.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  TS           - Test Switches: SW7-0") ;
       pea       @m68kdebugHelp_117.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  TD           - Test Displays: LEDs and 7-Segment") ;
       pea       @m68kdebugHelp_118.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\n  WD/WS/WC/WK  - Watch Point: Display/Set/Clear/Kill") ;
       pea       @m68kdebugHelp_119.L
       jsr       (A2)
       addq.w    #4,A7
; printf(banner) ;
       move.l    D2,-(A7)
...
; else if( c == (char)('G'))  {           // go user program
       ...
       bne.s     menu_12
; printf("\r\nProgram Running.....") ;
       pea       @m68kdebugmenu_121.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nPress <RESET> button <Key0> on DE1 to stop") ;
       pea       @m68kdebugmenu_122.L
       jsr       (A2)
       addq.w    #4,A7
; GoFlag = 1 ;
       move.l    #1,_GoFlag.L
...
; DisableBreakPoints() ;
       jsr       _DisableBreakPoints
; printf("\r\nSingle Step  :[ON]") ;
       pea       @m68kdebugmenu_124.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nBreak Points :[Disabled]") ;
       pea       @m68kdebugmenu_125.L
       jsr       (A2)
       addq.w    #4,A7
...
; printf("\r\nPress 'G' to Trace Program from address $%X.....",PC) ;
       move.l    _PC.L,-(A7)
       pea       @m68kdebugmenu_126.L
       jsr       (A2)
       addq.w    #8,A7
; printf("\r\nPush <RESET Button> to Stop.....") ;
       pea       @m68kdebugmenu_127.L
       jsr       (A2)
       addq.w    #4,A7
; DumpRegisters() ;
       jsr       _DumpRegisters
...
; SR = SR & (unsigned short int)(0x7FFF) ;    // clear T bit in status register
       and.w     #32767,(A5)
; printf("\r\nSingle Step : [OFF]") ;
       pea       @m68kdebugmenu_128.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nBreak Points :[Enabled]") ;
       pea       @m68kdebugmenu_129.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nPress <ESC> to Resume User Program.....") ;
       pea       @m68kdebugmenu_130.L
       jsr       (A2)
       addq.w    #4,A7
menu_42:
       bra       menu_46
...
; SR = SR & (unsigned short int)(0x7FFF) ;    // clear T bit in status register
       and.w     #32767,(A5)
; printf("\r\nSingle Step  :[OFF]") ;
       pea       @m68kdebugmenu_131.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nBreak Points :[Enabled]");
       pea       @m68kdebugmenu_132.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nProgram Running.....") ;
       pea       @m68kdebugmenu_133.L
       jsr       (A2)
       addq.w    #4,A7
; printf("\r\nPress <RESET> button <Key0> on DE1 to stop") ;
       pea       @m68kdebugmenu_134.L
       jsr       (A2)
       addq.w    #4,A7
; return ;
       bra.s     menu_38
...
_PrintErrorMessageandAbort:
       link      A6,#0
; printf("\r\n\r\nProgram ABORT !!!!!!\r\n") ;
       pea       @m68kdebugPrintErrorMessageandAbort_135.L
       jsr       _printf
       addq.w    #4,A7
; printf("%s\r\n", string) ;
       move.l    8(A6),-(A7)
       pea       @m68kdebugPrintErrorMessageandAbort_136.L
       jsr       _printf
       addq.w    #8,A7
; menu() ;
       jsr       _menu
...
_IRQMessage:
       link      A6,#0
; printf("\r\n\r\nProgram ABORT !!!!!");
       pea       @m68kdebugIRQMessage_137.L
       jsr       _printf
       addq.w    #4,A7
; printf("\r\nUnhandled Interrupt: IRQ%d !!!!!", level) ;
       move.l    8(A6),-(A7)
       pea       @m68kdebugIRQMessage_138.L
       jsr       _printf
       addq.w    #8,A7
; menu() ;
       jsr       _menu
...
; PrintErrorMessageandAbort("ADDRESS ERROR: 16 or 32 Bit Transfer to/from an ODD Address....") ;
       pea       @m68kdebugUnhandledIRQ6_139.L
...
; PrintErrorMessageandAbort("Unhandled Trap !!!!!") ;
       pea       @m68kdebugUnhandledTrap_140.L
       jsr       _PrintErrorMessageandAbort
       addq.w    #4,A7
       rts
; }
...
; PrintErrorMessageandAbort("ADDRESS Error!") ;
       pea       @m68kdebugAddressError_142.L
       jsr       _PrintErrorMessageandAbort
       addq.w    #4,A7
       rts
; }
...
; PrintErrorMessageandAbort("ILLEGAL INSTRUCTION") ;
       pea       @m68kdebugIllegalInstruction_143.L
       jsr       _PrintErrorMessageandAbort
       addq.w    #4,A7
       rts
; }
...
; PrintErrorMessageandAbort("DIVIDE BY ZERO") ;
       pea       @m68kdebugDividebyzero_144.L
       jsr       _PrintErrorMessageandAbort
       addq.w    #4,A7
       rts
; }
...
; printf("\r\nStart Address in Memory: ") ;
       pea       @m68kdebugEnterString_150.L
       jsr       _printf
       addq.w    #4,A7
...
; printf("\r\nEnter String (ESC to end) :") ;
       pea       @m68kdebugEnterString_151.L
       jsr       _printf
       addq.w    #4,A7
...
; char *BugMessage = "DE1-68k Bug V1.77";
       lea       @m68kdebugmain_154.L,A0
       move.l    A0,D3
; char *CopyrightMessage = "Copyright (C) PJ Davies 2016";
       lea       @m68kdebugmain_155.L,A0
       move.l    A0,-4(A6)
; KillAllBreakPoints() ;
       jsr       _KillAllBreakPoints
...
; LoadFromFlashChip();
       jsr       _LoadFromFlashChip
; printf("\r\nRunning.....") ;
       pea       @m68kdebugmain_156.L
       jsr       (A3)
       addq.w    #4,A7
; Oline1("Running.....") ;
       pea       @m68kdebugmain_157.L
       jsr       _Oline1
       addq.w    #4,A7
; GoFlag = 1;
       move.l    #1,_GoFlag.L
...
; Oline0(BugMessage) ;
       ...
       addq.w    #4,A7
; Oline1("By: PJ Davies") ;
       pea       @m68kdebugmain_158.L
       jsr       _Oline1
       addq.w    #4,A7
; printf("\r\n%s", BugMessage) ;
       move.l    D3,-(A7)
       pea       @m68kdebugmain_159.L
       jsr       (A3)
       addq.w    #8,A7
; printf("\r\n%s", CopyrightMessage) ;
       move.l    -4(A6),-(A7)
       pea       @m68kdebugmain_160.L
       jsr       (A3)
       addq.w    #8,A7
; menu();
       jsr       _menu
...
; }
       section   const
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_1:
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_2:
       dc.b      13,83,119,105,116,99,104,101,115,32,83,87,91
       dc.b      55,45,48,93,32,61,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_3:
       dc.b      48,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_4:
       dc.b      49,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_5:
       ...
       dc.b      110,117,101,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_6:
       dc.b      13,10,69,110,116,101,114,32,83,116,97,114,116
       dc.b      32,65,100,100,114,101,115,115,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_7:
       dc.b      13,10,37,48,56,120,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_8:
       dc.b      37,48,50,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_9:
       dc.b      32,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_10:
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_11:
       dc.b      13,10,70,105,108,108,32,77,101,109,111,114,121
       dc.b      32,66,108,111,99,107,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_12:
       dc.b      13,10,69,110,116,101,114,32,83,116,97,114,116
       dc.b      32,65,100,100,114,101,115,115,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_13:
       dc.b      13,10,69,110,116,101,114,32,69,110,100,32,65
       dc.b      100,100,114,101,115,115,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_14:
       dc.b      13,10,69,110,116,101,114,32,70,105,108,108,32
       dc.b      68,97,116,97,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_15:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_16:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_17:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_18:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_20:
       ...
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_21:
       dc.b      13,10,69,110,116,101,114,32,65,100,100,114,101
       dc.b      115,115,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_22:
       dc.b      13,10,91,37,48,56,120,93,32,58,32,37,48,50,120
       dc.b      32,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_23:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_24:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_25:
       dc.b      36,37,48,56,88,32,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_26:
       dc.b      37,48,50,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_27:
       dc.b      32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_28:
       dc.b      32,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_29:
       dc.b      46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_30:
       dc.b      37,99,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_31:
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_32:
       dc.b      13,10,13,10,32,68,48,32,61,32,36,37,48,56,88
       dc.b      32,32,65,48,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_33:
       dc.b      13,10,32,68,49,32,61,32,36,37,48,56,88,32,32
       dc.b      65,49,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_34:
       dc.b      13,10,32,68,50,32,61,32,36,37,48,56,88,32,32
       dc.b      65,50,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_35:
       dc.b      13,10,32,68,51,32,61,32,36,37,48,56,88,32,32
       dc.b      65,51,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_36:
       dc.b      13,10,32,68,52,32,61,32,36,37,48,56,88,32,32
       dc.b      65,52,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_37:
       dc.b      13,10,32,68,53,32,61,32,36,37,48,56,88,32,32
       dc.b      65,53,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_38:
       dc.b      13,10,32,68,54,32,61,32,36,37,48,56,88,32,32
       dc.b      65,54,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_39:
       dc.b      13,10,32,68,55,32,61,32,36,37,48,56,88,32,32
       dc.b      65,55,32,61,32,36,37,48,56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_40:
       dc.b      13,10,13,10,85,83,80,32,61,32,36,37,48,56,88
       dc.b      32,32,40,65,55,41,32,85,115,101,114,32,83,80
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_41:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_42:
       dc.b      13,10,32,83,82,32,61,32,36,37,48,52,88,32,32
       dc.b      32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_43:
       dc.b      32,32,32,91,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_44:
       dc.b      13,10,32,80,67,32,61,32,36,37,48,56,88,32,32
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_45:
       dc.b      91,64,32,66,82,69,65,75,80,79,73,78,84,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_46:
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_47:
       dc.b      13,10,87,80,37,100,32,61,32,37,115,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_48:
       dc.b      13,10,13,10,13,10,13,10,13,10,13,10,83,105,110
       dc.b      103,108,101,32,83,116,101,112,32,32,58,91,79
       dc.b      78,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_49:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      115,32,58,91,68,105,115,97,98,108,101,100,93
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_50:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_51:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_52:
       ...
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_53:
       dc.b      13,10,68,37,99,32,61,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_54:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_55:
       dc.b      13,10,65,37,99,32,61,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_56:
       dc.b      13,10,85,115,101,114,32,83,80,32,61,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_57:
       dc.b      13,10,73,108,108,101,103,97,108,32,82,101,103
       dc.b      105,115,116,101,114,46,46,46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_58:
       dc.b      13,10,83,121,115,116,101,109,32,83,80,32,61
       dc.b      32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_59:
       dc.b      13,10,73,108,108,101,103,97,108,32,82,101,103
       dc.b      105,115,116,101,114,46,46,46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_60:
       dc.b      13,10,80,67,32,61,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_61:
       dc.b      13,10,83,82,32,61,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_62:
       dc.b      13,10,73,108,108,101,103,97,108,32,82,101,103
       ...
       dc.b      82,13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_63:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_64:
       dc.b      13,10,45,45,45,32,32,32,32,32,45,45,45,45,45
       dc.b      45,45,45,45,32,32,32,32,45,45,45,45,45,45,45
       dc.b      45,45,45,45,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_65:
       dc.b      13,10,78,111,32,66,114,101,97,107,80,111,105
       dc.b      110,116,115,32,83,101,116,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_66:
       dc.b      13,10,37,51,100,32,32,32,32,32,36,37,48,56,120
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_67:
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_68:
       dc.b      13,10,78,117,109,32,32,32,32,32,65,100,100,114
       dc.b      101,115,115,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_69:
       dc.b      13,10,45,45,45,32,32,32,32,32,45,45,45,45,45
       dc.b      45,45,45,45,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_70:
       dc.b      13,10,78,111,32,87,97,116,99,104,80,111,105
       dc.b      110,116,115,32,83,101,116,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_71:
       dc.b      13,10,37,51,100,32,32,32,32,32,36,37,48,56,120
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_72:
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_73:
       dc.b      13,10,69,110,116,101,114,32,66,114,101,97,107
       dc.b      32,80,111,105,110,116,32,78,117,109,98,101,114
       dc.b      58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_74:
       dc.b      13,10,73,108,108,101,103,97,108,32,82,97,110
       dc.b      103,101,32,58,32,85,115,101,32,48,32,45,32,55
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_75:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      32,67,108,101,97,114,101,100,46,46,46,46,46
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_76:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      32,119,97,115,110,39,116,32,83,101,116,46,46
       dc.b      46,46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_77:
       dc.b      13,10,69,110,116,101,114,32,87,97,116,99,104
       dc.b      32,80,111,105,110,116,32,78,117,109,98,101,114
       dc.b      58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_78:
       dc.b      13,10,73,108,108,101,103,97,108,32,82,97,110
       dc.b      103,101,32,58,32,85,115,101,32,48,32,45,32,55
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_79:
       dc.b      13,10,87,97,116,99,104,32,80,111,105,110,116
       dc.b      32,67,108,101,97,114,101,100,46,46,46,46,46
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_80:
       dc.b      13,10,87,97,116,99,104,32,80,111,105,110,116
       dc.b      32,87,97,115,32,110,111,116,32,83,101,116,46
       dc.b      46,46,46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_81:
       dc.b      13,10,78,111,32,70,82,69,69,32,66,114,101,97
       dc.b      107,32,80,111,105,110,116,115,46,46,46,46,46
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_82:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      32,65,100,100,114,101,115,115,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_83:
       ...
       dc.b      115,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_84:
       dc.b      13,10,69,114,114,111,114,32,58,32,66,114,101
       dc.b      97,107,32,80,111,105,110,116,115,32,67,65,78
       ...
       dc.b      70,70,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_85:
       ...
       dc.b      56,120,13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_86:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      32,83,101,116,32,97,116,32,65,100,100,114,101
       dc.b      115,115,58,32,91,36,37,48,56,120,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_87:
       dc.b      13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_88:
       dc.b      13,10,78,111,32,70,82,69,69,32,87,97,116,99
       dc.b      104,32,80,111,105,110,116,115,46,46,46,46,46
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_89:
       dc.b      13,10,87,97,116,99,104,32,80,111,105,110,116
       dc.b      32,65,100,100,114,101,115,115,58,32,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_90:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_101:
       dc.b      13,10,75,105,108,108,32,65,108,108,32,87,97
       dc.b      116,99,104,32,80,111,105,110,116,115,46,46,46
       dc.b      40,121,47,110,41,63,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_102:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_103:
       dc.b      13,10,32,32,68,101,98,117,103,103,101,114,32
       dc.b      67,111,109,109,97,110,100,32,83,117,109,109
       dc.b      97,114,121,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_104:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_105:
       ...
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_106:
       ...
       dc.b      111,114,121,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_107:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_108:
       ...
       dc.b      111,114,121,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_109:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_110:
       ...
       dc.b      56,88,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_111:
       ...
       dc.b      112,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_112:
       ...
       dc.b      110,103,101,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_113:
       ...
       dc.b      111,103,114,97,109,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_114:
       ...
       dc.b      115,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_115:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_116:
       dc.b      13,10,32,32,84,77,32,32,32,32,32,32,32,32,32
       dc.b      32,32,45,32,84,101,115,116,32,77,101,109,111
       dc.b      114,121,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_117:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_118:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_119:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_120:
       dc.b      13,10,35,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_121:
       dc.b      13,10,80,114,111,103,114,97,109,32,82,117,110
       dc.b      110,105,110,103,46,46,46,46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_122:
       ...
       dc.b      116,111,112,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_123:
       ...
       dc.b      114,97,109,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_124:
       dc.b      13,10,83,105,110,103,108,101,32,83,116,101,112
       dc.b      32,32,58,91,79,78,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_125:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      115,32,58,91,68,105,115,97,98,108,101,100,93
       dc.b      0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_126:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_127:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_128:
       dc.b      13,10,83,105,110,103,108,101,32,83,116,101,112
       dc.b      32,58,32,91,79,70,70,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_129:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      115,32,58,91,69,110,97,98,108,101,100,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_130:
       dc.b      13,10,80,114,101,115,115,32,60,69,83,67,62,32
       dc.b      116,111,32,82,101,115,117,109,101,32,85,115
       dc.b      101,114,32,80,114,111,103,114,97,109,46,46,46
       dc.b      46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_131:
       dc.b      13,10,83,105,110,103,108,101,32,83,116,101,112
       dc.b      32,32,58,91,79,70,70,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_132:
       dc.b      13,10,66,114,101,97,107,32,80,111,105,110,116
       dc.b      115,32,58,91,69,110,97,98,108,101,100,93,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_133:
       dc.b      13,10,80,114,111,103,114,97,109,32,82,117,110
       dc.b      110,105,110,103,46,46,46,46,46,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_134:
       dc.b      13,10,80,114,101,115,115,32,60,82,69,83,69,84
       dc.b      62,32,98,117,116,116,111,110,32,60,75,101,121
       dc.b      48,62,32,111,110,32,68,69,49,32,116,111,32,115
       dc.b      116,111,112,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_135:
       dc.b      13,10,13,10,80,114,111,103,114,97,109,32,65
       dc.b      66,79,82,84,32,33,33,33,33,33,33,13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_136:
       dc.b      37,115,13,10,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_137:
       dc.b      13,10,13,10,80,114,111,103,114,97,109,32,65
       dc.b      66,79,82,84,32,33,33,33,33,33,0
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_138:
...
@m68kdebug@m68kdebug@m68kdebug@m68kdebug@m68kd_139:
