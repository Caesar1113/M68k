...
void MemoryTest(void)
{
     ...
     */
    printf("\r\nSetting up test address range: 0x08020000 to 0x08030000\n");
    do
    {
        addr_err = 0;
        printf("\r\nStart Address: ");
        ...
        if (Start < 0x08020000)
        {
            printf("Err: start address smaller than 0x08020000\n");
            addr_err = 1;
        }
        else if (Start > 0x08030000)
        {
            printf("Err: start address larger than 0x08030000\n");
            addr_err = 1;
        }
    ...
    do
    {
        ...
        if (End < 0x08020000)
        {
            printf("Err: end address smaller than 0x08020000\n");
            addr_err = 1;
        }
        else if (End > 0x08030000)
        {
            printf("Err: end address larger than 0x08030000\n");
            addr_err = 1;
        }
        else if (End < Start)
        {
