...
; scanflush() ;                       // flush any text that may have been typed ahead
       jsr       _scanflush
; printf("\r\nEnter Integer: ") ;
       pea       @m68kuserpmain_1.L
       jsr       (A3)
       addq.w    #4,A7
; scanf("%d", &i) ;
       pea       -168(A6)
       pea       @m68kuserpmain_2.L
       jsr       _scanf
       addq.w    #8,A7
; printf("You entered %d", i) ;
       move.l    -168(A6),-(A7)
       pea       @m68kuserpmain_3.L
       jsr       (A3)
       addq.w    #8,A7
; sprintf(text, "Hello CPEN 412 Student") ;
       pea       @m68kuserpmain_4.L
       pea       -154(A6)
       jsr       _sprintf
       addq.w    #8,A7
...
; printf("\r\nHello CPEN 412 Student\r\nYour LEDs should be Flashing") ;
       pea       @m68kuserpmain_5.L
       jsr       (A3)
       addq.w    #4,A7
; printf("\r\nYour LCD should be displaying") ;
       pea       @m68kuserpmain_6.L
       jsr       (A3)
       addq.w    #4,A7
; while(1)
main_1:
...
; }
       section   const
@m68kuserp@m68kuserp@m68kuserp@m68kuserp@m68_1:
       dc.b      13,10,69,110,116,101,114,32,73,110,116,101,103
       dc.b      101,114,58,32,0
@m68kuserp@m68kuserp@m68kuserp@m68kuserp@m68_2:
       dc.b      37,100,0
@m68kuserp@m68kuserp@m68kuserp@m68kuserp@m68_3:
       dc.b      89,111,117,32,101,110,116,101,114,101,100,32
       dc.b      37,100,0
@m68kuserp@m68kuserp@m68kuserp@m68kuserp@m68_4:
       dc.b      72,101,108,108,111,32,67,80,69,78,32,52,49,50
       dc.b      32,83,116,117,100,101,110,116,0
@m68kuserp@m68kuserp@m68kuserp@m68kuserp@m68_5:
       ...
       dc.b      103,0
@m68kuserp@m68kuserp@m68kuserp@m68kuserp@m68_6:
